...
let settings = {
  ...
  defaultPerPage: 50,
  ajax: '/get_table_dckbsl?user=test',
  requestType: 'GET',
  columns: [
    {
      data: "year",
...
class DckbslTable extends React.Component {
    componentWillMount() {
        settings.ajax = '/get_table_dckbsl?user='+cookies.get('username');
