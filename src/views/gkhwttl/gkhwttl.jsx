...
class gkhwttl extends React.Component{
    state = {
        value: 0,
        open: false,
        //yhgkhwttl: false,
    ...
    get_yhgkhwttl_year = () => {
        userService.get_yhgkhwttl_year()
            .then(
                yhgkhwttl_year => { 
    ...
    update_yhgkhwttl = (year) => {
        ...
        //     return;
        userService.get_yhgkhwttl(year)
            .then(
                yhgkhwttl => { 
    ...
    update_yhgkhwttl_jxsp = (gk_index) => {
        userService.get_yhgkhwttl_jxsp(this.gks[gk_index])
            .then(
                gkhwttl_jxsp => {
                    ...
                    let this_gk = gkhwttl_jxsp.map((item,index) => { return item.gkhwttl; });
...
export default withStyles(dashboardStyle)(gkhwttl);
