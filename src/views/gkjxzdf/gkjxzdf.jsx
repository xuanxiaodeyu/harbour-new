...
function openDataUriWindow(url) {
    var url_with_name = url.replace("data:application/pdf;", "data:application/pdf;name=港口绩效报告.pdf;")
    var html = '<html>' +
...
class gkjxzdf extends React.Component{
    state = {
        value: 0,
        open: false,
        yhgkhwttl: false,
...
export default withStyles(dashboardStyle)(gkjxzdf);
