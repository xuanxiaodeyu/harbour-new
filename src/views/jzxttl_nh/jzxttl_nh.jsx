...
class jzxttl_nh extends React.Component{
    state = {
        value: 0,
        open: false,
        //jzxttl: false,
    ...
    get_jzxttl_year = () => {
        userService.get_jzxttl_nh_year()
            .then(
                jzxttl_year => { 
    ...
    update_jzxttl = (year) => {
        ...
        //     return;
        userService.get_jzxttl_nh(year)
            .then(
                jzxttl => { 
    ...
    update_jzxttl_jxsp = (gk_index) => {
        userService.get_jzxttl_nh_jxsp(this.gks[gk_index])
            .then(
                jzxttl_jxsp => {
                    ...
                    let this_gk = jzxttl_jxsp.map((item,index) => { return item.metric; });
                    var option = {
                        graphic: {
                            type: 'group',
                            rotation: Math.PI / 4,
...
export default withStyles(dashboardStyle)(jzxttl_nh);
