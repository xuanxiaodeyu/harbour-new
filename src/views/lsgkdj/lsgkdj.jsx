...
class lsgkdj extends React.Component{
    state = {
        value: 0,
        open: false,
        //lsgkdj: false,
    ...
    update_lsgkdj_jxsp = (gk_index) => {
        userService.get_lsgkdj_jxsp(this.gks[gk_index])
            .then(
                lsgkdj_jxsp => {
...
export default withStyles(dashboardStyle)(lsgkdj);
