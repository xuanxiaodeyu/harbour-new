...
class mtnlsyd_nh extends React.Component{
    state = {
        value: 0,
        open: false,
        //mtnlsyd: false,
    ...
    update_mtnlsyd_jxsp = (gk_index) => {
        userService.get_mtnlsyd_nh_jxsp(this.gks[gk_index])
            .then(
                mtnlsyd_jxsp => {
                    ...
                    let this_gk = mtnlsyd_jxsp.map((item,index) => { return item.metric; });
                    var option = {
                        graphic: {
                            type: 'group',
                            rotation: Math.PI / 4,
    ...
    get_mtnlsyd_year = () => {
        userService.get_mtnlsyd_nh_year()
            .then(
                mtnlsyd_year => { 
    ...
    update_mtnlsyd = (year) => {
        userService.get_mtnlsyd_nh(year)
            .then(
                mtnlsyd => { 
                    let gkArray = mtnlsyd.map((item,index) => { return  item.gk; });
                    let mtnlsydArray = mtnlsyd.map((item,index) => { return item.gktgnlsyd; });
                    var option = {
                        graphic: {
                            type: 'group',
                            rotation: Math.PI / 4,
    ...
    update_mtnlsyd_metric = (year) => {
        userService.get_mtnlsyd_nh_metric(year)
            .then(
                mtnlsyd_metric => { 
...
mtnlsyd_nh.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(dashboardStyle)(mtnlsyd_nh);
