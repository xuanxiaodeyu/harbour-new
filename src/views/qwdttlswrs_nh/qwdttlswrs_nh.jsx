...
class qwdttlswrs_nh extends React.Component{
    state = {
        value: 0,
        open: false,
        //qwdttlswrs: false,
    ...
    get_qwdttlswrs_gk = () => {
        userService.get_qwdttlswrs_nh_gk()
            .then(
                qwdttlswrs_gk => {
    ...
    update_qwdttlswrs_jxsp = (gk_index) => {
        userService.get_qwdttlswrs_nh_jxsp(this.gks[gk_index])
            .then(
                qwdttlswrs_jxsp => {
                    ...
                    let this_gk = qwdttlswrs_jxsp.map((item,index) => { return item.gkaqscsp; });
                    var option = {
                        graphic: {
                            type: 'group',
                            rotation: Math.PI / 4,
    ...
    get_qwdttlswrs_year = () => {
        userService.get_qwdttlswrs_nh_year()
            .then(
                qwdttlswrs_year => { 
    ...
    update_qwdttlswrs = (year) => {
        userService.get_qwdttlswrs_nh(year)
            .then(
                qwdttlswrs => { 
                    
                    let gkArray = qwdttlswrs.map((item,index) => { return  item.gk; });
                    let qwdttlswrsArray = qwdttlswrs.map((item,index) => { return item.gkaqscsp; });
                    var option = {
                        graphic: {
                            type: 'group',
                            rotation: Math.PI / 4,
...
qwdttlswrs_nh.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(dashboardStyle)(qwdttlswrs_nh);
